<?php if (!defined('THINK_PATH')) exit();?><!-- 顶部导航 start -->
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <?php if($_SESSION['user_id']!= ''): ?><li>您好,<?php echo (session('user_name')); ?>,欢迎来到京西！[<a href="<?php echo U('User/loginOut');?>">退出</a>] </li>
                    <?php else: ?>
				...
				<form action="" method="post">
					<ul>
						...
						<li>
							...
							<input type="password" class="txt" name="user_pwdr" />
							<p> <span>请再次输入密码</p>
						</li>
						<li>
							<label for="">&nbsp;</label>
